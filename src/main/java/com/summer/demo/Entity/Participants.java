...
public class Participants {
    ...
    @ManyToOne
    @JoinColumn(name = "user_id",foreignKey = @ForeignKey(name = "PERSONALUSER_USER_ID_FK2"))
    private PersonalUser personalUser;

    @ManyToOne
    @JoinColumn(name = "meeting_id",foreignKey = @ForeignKey(name ="MEETING_MEETING_ID_FK2"))
